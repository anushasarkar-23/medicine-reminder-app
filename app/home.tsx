...
export default function HomeScreen() {
  ...
  const loadMedications = useCallback(async () => {
    try {
      ...
      const todayMeds = allMedications.filter((med) => {
        ...
        // Handle "Ongoing" duration
        if (med.duration === "Ongoing") {
          return today >= startDate;
        }
        
        // Parse duration for other cases
  ...
  const setupNotifications = async () => {
    try {
      ...
      if (!result) {
        console.log("Failed to set up notifications");
        return;
      }
  ...
  // Calculate total doses for today based on actual medication times
        ...
        <View style={styles.headerContent}>
          <View style={styles.headerTop}>
            <View style={styles.flex1}>
              ...
              <Text style={styles.subGreeting}>Track your medication schedule</Text>
            </View>
            <TouchableOpacity
